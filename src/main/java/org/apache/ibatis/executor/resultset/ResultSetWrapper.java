...
class ResultSetWrapper {
    ...
    public TypeHandler<?> getTypeHandler(Class<?> propertyType, String columnName) {
        log.debug("getTypeHandler({},{})", propertyType, columnName);
    ...
    private Class<?> resolveClass(String className) {
        log.debug("resolveClass({})", className);
        try {
    ...
    private void loadMappedAndUnmappedColumnNames(ResultMap resultMap, String columnPrefix) throws SQLException {
        log.debug("loadMappedAndUnmappedColumnNames({},{})", resultMap, columnPrefix);
    ...
    public List<String> getMappedColumnNames(ResultMap resultMap, String columnPrefix) throws SQLException {
        log.debug("getMappedColumnNames({},{})", resultMap, columnPrefix);
    ...
    public List<String> getUnmappedColumnNames(ResultMap resultMap, String columnPrefix) throws SQLException {
        log.debug("getUnmappedColumnNames({},{})", resultMap, columnPrefix);
    ...
    private String getMapKey(ResultMap resultMap, String columnPrefix) {
        log.debug("getMapKey({},{})", resultMap, columnPrefix);
        return resultMap.getId() + ":" + columnPrefix;
    }

    private Set<String> prependPrefixes(Set<String> columnNames, String prefix) {
        log.debug("prependPrefixes({},{})", columnNames, prefix);
